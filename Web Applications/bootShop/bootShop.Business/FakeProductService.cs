            ...
            products = new List<Product>
             {
                 ...
                 new Product{ Id=3, Name="MacBook Air ", Price=10000, Discount=0.15, Descriptipn="8 GB ram", CategoryId=1, ImageUrl="https://productimages.hepsiburada.net/s/137/222-222/110000089760432.jpg"},
                  new Product{ Id=4, Name="A", Price=10000, Discount=0.15, Descriptipn="8 GB ram", CategoryId=1, ImageUrl="https://productimages.hepsiburada.net/s/137/222-222/110000089760432.jpg"},
                 ...
                 new Product{ Id=6, Name="C", Price=10000, Discount=0.15, Descriptipn="8 GB ram", CategoryId=1, ImageUrl="https://productimages.hepsiburada.net/s/137/222-222/110000089760432.jpg"},
             };
        }
